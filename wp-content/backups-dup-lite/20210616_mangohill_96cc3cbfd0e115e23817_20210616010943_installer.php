...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210616_mangohill_96cc3cbfd0e115e23817_20210616010943_archive.zip';
	const ARCHIVE_SIZE		 = '65654605';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '96cc3cb-16010943';
    const SECONDARY_PACKAGE_HASH = '0940f82-16010943';
	const VERSION			 = '1.4.1';
